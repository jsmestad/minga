defmodule MingaGitPorcelain.PickerBranchDeleteShortcutTest do
  @moduledoc "Tests the branch picker Ctrl-D shortcut in a serial test because it uses the global Minga.Project singleton."

  # Serial because this test switches the global Minga.Project singleton.
  ...
  defp picker_state(picker) do
    picker_state = %PickerState{
      picker: picker,
      source: MingaGitPorcelain.UI.Picker.GitBranchSource,
      restore: 0
    }
