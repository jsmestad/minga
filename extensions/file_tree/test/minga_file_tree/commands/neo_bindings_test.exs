defmodule MingaFileTree.CommandsNeoBindingsTest do
  @moduledoc """
  ...
  alias MingaFileTree.Commands, as: FileTreeCommands
  ...
  describe "filter and help state" do
    ...
    test "filter starts filtering and narrows visible entries", %{tmp_dir: tmp_dir} do
      ...
      file_tree = MingaFileTree.State.update_filter(ft(state), "alpha")
