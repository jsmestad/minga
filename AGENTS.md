...
3. **macOS GUI:** Use the generated constants from `.generated/protocol/swift/ProtocolOpcodes.generated.swift`, add decoder behavior in `macos/Sources/Protocol/ProtocolDecoder.swift`, and add the handler in `CommandDispatcher.swift`.
