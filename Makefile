...
help:
	...
	@printf "  \033[1mbin/minga\033[0m          Launch the default Go/Bubble Tea TUI\n"
	@printf "  \033[1mMINGA_FRONTEND=zig bin/minga\033[0m  Launch the legacy Zig TUI (escape hatch)\n"
	...
	@printf "  \033[1mmake native.tui\033[0m     Build the TUI binaries (Go renderer, Zig renderer, parser)\n"
