defmodule Minga.EditingModel.CUA do
  @moduledoc """
  ...
  @spec process_key(t(), Minga.EditingModel.key()) ::
          {Minga.EditingModel.mode_label(), [Minga.EditingModel.command()], t()}
