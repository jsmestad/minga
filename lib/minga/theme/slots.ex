defmodule Minga.Theme.Slots do
  @moduledoc """
  ...
  """
  @spec to_color_pairs(Minga.Theme.t()) :: [color_pair()]
  def to_color_pairs(%Minga.Theme{} = theme) do
    e = theme.editor
    t = theme.tree
    tb = theme.tab_bar
    p = theme.popup
  ...
  @spec mode_color(Minga.Theme.Modeline.t(), atom()) ::
          {Minga.Theme.color(), Minga.Theme.color()}
