defmodule Minga.Input do
  ...
  2. AgentPanel — agent chat input (temporary, until agent becomes a buffer)
  3. FileTree — file tree navigation (temporary, until tree becomes a buffer)
  4. Picker — modal overlay, blocks all input while active
  5. Completion — insert-mode sub-dispatch for popup navigation
  6. GlobalBindings — Ctrl+S save, Ctrl+Q quit (always active)
  7. ModeFSM — the normal vim mode system (fallback)
  """
