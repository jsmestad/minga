defmodule Minga.Keymap.Defaults do
  ...
  @leader_bindings [
    ...
    {~k(g P), :git_push, "Push"},
    {~k(g p), :git_pull, "Pull"},
    {~k(g F), :git_fetch, "Fetch"},
    {~k(g d), :git_diff_file, "View diff"},
    {~k(g s), :git_stage_file, "Stage file"},
    {~k(g u), :git_unstage_file, "Unstage file"},
    {~k(g r), :git_revert_hunk, "Revert hunk"},
    {~k(g v), :git_preview_hunk, "Preview hunk"},
    {~k(g b), :git_blame_line, "Blame line"},
