defmodule Minga.Keymap.Defaults do
  ...
  @leader_bindings [
    ...
    {[{?c, @none}, {?h, @none}], :call_hierarchy, "Call hierarchy (incoming)"},
    {[{?c, @none}, {?H, @none}], :call_hierarchy_outgoing, "Call hierarchy (outgoing)"},
    {[{?c, @none}, {?v, @none}], :selection_expand, "Smart selection expand"},
    {[{?c, @none}, {?V, @none}], :selection_shrink, "Smart selection shrink"},
    ...
    # ── Open ──────────────────────────────────────────────────────────────────
    {[{?o, @none}, {?b, @none}], :toggle_beam_observatory, "BEAM observatory"},
    ...
    {[{?a, @none}, {?T, @none}], :agent_pick_thinking, "Pick thinking level"},
    ...
    {[{9, @none}, {9, @none}], :workspace_toggle, "Toggle workspace"},
    {[{9, @none}, {?N, @none}], :workspace_next, "Next workspace"},
    {[{9, @none}, {?P, @none}], :workspace_prev, "Previous workspace"},
    {[{9, @none}, {?A, @none}], :workspace_next_agent, "Next workspace"},
    {[{9, @none}, {?m, @none}], :manual_workspace, "Manual workspace"},
