defmodule Minga.Editing.Fold.Range do
  ...
  Produced by syntax/tree queries and consumed by `FoldMap`. Ranges may nest for recursive folds, but partial overlaps are rejected by the fold map on insertion.
