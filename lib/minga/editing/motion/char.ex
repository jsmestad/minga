defmodule Minga.Editing.Motion.Char do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Minga.Editing.Motion.Char.find_char_forward(buf, {0, 0}, "o")
      {0, 4}
  """
  ...
  ## Examples
      ...
      iex> buf = Minga.Buffer.Document.new("hello world")
      iex> Minga.Editing.Motion.Char.find_char_backward(buf, {0, 7}, "o")
      {0, 4}
  """
  ...
  ## Examples
      ...
      iex> buf = Minga.Buffer.Document.new("hello world")
      iex> Minga.Editing.Motion.Char.till_char_forward(buf, {0, 0}, "o")
      {0, 3}
  """
  ...
  ## Examples
      ...
      iex> buf = Minga.Buffer.Document.new("hello world")
      iex> Minga.Editing.Motion.Char.till_char_backward(buf, {0, 7}, "o")
      {0, 5}
  """
