defmodule Minga.Editing.Motion.Document do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Minga.Editing.Motion.Document.document_start(Minga.Buffer.Document.new("hello\\nworld"))
      {0, 0}
  """
  ...
  ## Examples
      ...
      iex> Minga.Editing.Motion.Document.document_end(buf)
      {1, 4}
  """
  ...
  ## Examples
      ...
      iex> buf = Minga.Buffer.Document.new("hello\\nworld\\n\\nfoo")
      iex> Minga.Editing.Motion.Document.paragraph_forward(buf, {0, 0})
      {2, 0}
  """
  ...
  ## Examples
      ...
      iex> buf = Minga.Buffer.Document.new("hello\\nworld\\n\\nfoo")
      iex> Minga.Editing.Motion.Document.paragraph_backward(buf, {3, 0})
      {2, 0}
  """
