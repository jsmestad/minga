defmodule Minga.Editing.NavigableContent.BufferSnapshot do
  @moduledoc """
...
defimpl Minga.Editing.NavigableContent, for: Minga.Editing.NavigableContent.BufferSnapshot do
  @moduledoc false

  alias Minga.Buffer.Document
  alias Minga.Editing.NavigableContent.BufferSnapshot

  @spec cursor(BufferSnapshot.t()) :: Minga.Editing.NavigableContent.position()
  def cursor(%BufferSnapshot{document: doc}), do: Document.cursor(doc)

  @spec set_cursor(BufferSnapshot.t(), Minga.Editing.NavigableContent.position()) ::
          BufferSnapshot.t()
  ...
  @spec replace_range(
          BufferSnapshot.t(),
          Minga.Editing.NavigableContent.position(),
          Minga.Editing.NavigableContent.position(),
          String.t()
        ) :: BufferSnapshot.t()
  ...
  @spec scroll(BufferSnapshot.t()) :: Minga.Editing.Scroll.t()
  def scroll(%BufferSnapshot{scroll: scroll}), do: scroll

  @spec set_scroll(BufferSnapshot.t(), Minga.Editing.Scroll.t()) :: BufferSnapshot.t()
  def set_scroll(%BufferSnapshot{} = snapshot, scroll) do
    %{snapshot | scroll: scroll}
  end

  @spec search_forward(BufferSnapshot.t(), String.t(), Minga.Editing.NavigableContent.position()) ::
          Minga.Editing.NavigableContent.position() | nil
  ...
  @spec search_backward(BufferSnapshot.t(), String.t(), Minga.Editing.NavigableContent.position()) ::
          Minga.Editing.NavigableContent.position() | nil
...
defimpl Minga.Editing.Text.Readable, for: Minga.Editing.NavigableContent.BufferSnapshot do
  @moduledoc false
  ...
  @spec offset_to_position(BufferSnapshot.t(), non_neg_integer()) ::
          Minga.Editing.Text.Readable.position()
