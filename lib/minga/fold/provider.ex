defmodule Minga.Fold.Provider do
  @moduledoc """
  ...
  - `Minga.Fold.TreeSitterProvider` — uses tree-sitter `folds.scm` queries
  - Extensions can implement this behaviour for custom folding (e.g., org headings)

  Providers register themselves via `Minga.Fold.Registry` at startup.
