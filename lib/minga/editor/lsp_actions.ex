defmodule Minga.Editor.LspActions do
  ...
  def goto_definition(%EditorState{workspace: %{buffers: %{active: nil}}} = state) do
    %{state | status_msg: "No active buffer"}
  end

  def goto_definition(%EditorState{workspace: %{buffers: %{active: buf}}} = state) do
  ...
  def hover(%EditorState{workspace: %{buffers: %{active: nil}}} = state) do
    %{state | status_msg: "No active buffer"}
  end

  def hover(%EditorState{workspace: %{buffers: %{active: buf}}} = state) do
    case lsp_client_for(state, buf) do
      nil ->
        %{state | status_msg: "No language server"}
  ...
  def find_references(%EditorState{workspace: %{buffers: %{active: nil}}} = state) do
    %{state | status_msg: "No active buffer"}
  end

  def find_references(%EditorState{workspace: %{buffers: %{active: buf}}} = state) do
    case lsp_client_for(state, buf) do
      nil ->
        %{state | status_msg: "No language server"}
      ...
      client ->
        ...
        case file_path do
          ...
          path ->
            ...
            put_in(state.workspace.lsp_pending, Map.put(state.workspace.lsp_pending, ref, :references))
        end
    end
  end
  ...
  def document_highlight(%EditorState{workspace: %{buffers: %{active: nil}}} = state), do: state

  def document_highlight(%EditorState{workspace: %{buffers: %{active: buf}}} = state) do
    case lsp_client_for(state, buf) do
      nil ->
        state
  ...
  def schedule_document_highlight(%EditorState{workspace: %{buffers: %{active: nil}}} = state), do: state
  ...
  def code_action(%EditorState{workspace: %{buffers: %{active: nil}}} = state) do
    %{state | status_msg: "No active buffer"}
  end

  def code_action(%EditorState{workspace: %{buffers: %{active: buf}}} = state) do
    case lsp_client_for(state, buf) do
      nil ->
        %{state | status_msg: "No language server"}
      ...
      client ->
        ...
        case file_path do
          ...
          path ->
            ...
            put_in(state.workspace.lsp_pending, Map.put(state.workspace.lsp_pending, ref, :code_action))
        end
    end
  end
  ...
  def prepare_rename(%EditorState{workspace: %{buffers: %{active: nil}}} = state) do
    %{state | status_msg: "No active buffer"}
  end

  def prepare_rename(%EditorState{workspace: %{buffers: %{active: buf}}} = state) do
    case lsp_client_for(state, buf) do
      nil ->
        %{state | status_msg: "No language server"}
  ...
  def rename(%EditorState{workspace: %{buffers: %{active: nil}}} = state, _new_name) do
    %{state | status_msg: "No active buffer"}
  end

  def rename(%EditorState{workspace: %{buffers: %{active: buf}}} = state, new_name) do
    case lsp_client_for(state, buf) do
      nil ->
        %{state | status_msg: "No language server"}
      ...
      client ->
        ...
        case file_path do
          ...
          path ->
            ...
            put_in(state.workspace.lsp_pending, Map.put(state.workspace.lsp_pending, ref, :rename))
        end
    end
  end
  ...
  def goto_type_definition(%EditorState{workspace: %{buffers: %{active: nil}}} = state) do
    %{state | status_msg: "No active buffer"}
  end

  def goto_type_definition(%EditorState{workspace: %{buffers: %{active: buf}}} = state) do
    case lsp_client_for(state, buf) do
      nil ->
        %{state | status_msg: "No language server"}
  ...
  def goto_implementation(%EditorState{workspace: %{buffers: %{active: nil}}} = state) do
    %{state | status_msg: "No active buffer"}
  end

  def goto_implementation(%EditorState{workspace: %{buffers: %{active: buf}}} = state) do
    case lsp_client_for(state, buf) do
      nil ->
        %{state | status_msg: "No language server"}
  ...
  def document_symbols(%EditorState{workspace: %{buffers: %{active: nil}}} = state) do
    %{state | status_msg: "No active buffer"}
  end

  def document_symbols(%EditorState{workspace: %{buffers: %{active: buf}}} = state) do
    case lsp_client_for(state, buf) do
      nil ->
        %{state | status_msg: "No language server"}
      ...
      client ->
        ...
        case file_path do
          ...
          path ->
            ...
            put_in(state.workspace.lsp_pending, Map.put(state.workspace.lsp_pending, ref, :document_symbol))
        end
    end
  end
  ...
  def workspace_symbols(%EditorState{workspace: %{buffers: %{active: nil}}} = state, _query) do
    %{state | status_msg: "No active buffer"}
  end

  def workspace_symbols(%EditorState{workspace: %{buffers: %{active: buf}}} = state, query) do
    case lsp_client_for(state, buf) do
      nil ->
        %{state | status_msg: "No language server"}
      ...
      client ->
        ...
        put_in(state.workspace.lsp_pending, Map.put(state.workspace.lsp_pending, ref, :workspace_symbol))
    end
  end
  ...
  def selection_range(%EditorState{workspace: %{buffers: %{active: nil}}} = state) do
    %{state | status_msg: "No active buffer"}
  end

  def selection_range(%EditorState{workspace: %{buffers: %{active: buf}}} = state) do
    case lsp_client_for(state, buf) do
      nil ->
        %{state | status_msg: "No language server"}
      ...
      client ->
        ...
        case file_path do
          ...
          path ->
            ...
            put_in(state.workspace.lsp_pending, Map.put(state.workspace.lsp_pending, ref, :selection_range))
        end
    end
  end
  ...
  def selection_shrink(%{selection_ranges: [_ | _]} = state) do
    ...
    %{state | workspace: %{state.workspace | vim: vim}, selection_ranges: nil, selection_range_index: 0}
  end
  ...
  def prepare_call_hierarchy(%EditorState{workspace: %{buffers: %{active: nil}}} = state) do
    %{state | status_msg: "No active buffer"}
  end

  def prepare_call_hierarchy(%EditorState{workspace: %{buffers: %{active: buf}}} = state) do
    case lsp_client_for(state, buf) do
      nil ->
        %{state | status_msg: "No language server"}
  ...
  def prepare_outgoing_call_hierarchy(%EditorState{workspace: %{buffers: %{active: nil}}} = state) do
    %{state | status_msg: "No active buffer"}
  end

  def prepare_outgoing_call_hierarchy(%EditorState{workspace: %{buffers: %{active: buf}}} = state) do
    case lsp_client_for(state, buf) do
      nil ->
        %{state | status_msg: "No language server"}
  ...
  def code_lens(%EditorState{workspace: %{buffers: %{active: nil}}} = state) do
    %{state | status_msg: "No active buffer"}
  end

  def code_lens(%EditorState{workspace: %{buffers: %{active: buf}}} = state) do
    case lsp_client_for(state, buf) do
      nil ->
        state
      ...
      client ->
        ...
        case file_path do
          ...
          path ->
            ...
            put_in(state.workspace.lsp_pending, Map.put(state.workspace.lsp_pending, ref, :code_lens))
        end
    end
  end
  ...
  def inlay_hints(%EditorState{workspace: %{buffers: %{active: nil}}} = state) do
    %{state | status_msg: "No active buffer"}
  end

  def inlay_hints(%EditorState{workspace: %{buffers: %{active: buf}}} = state) do
    case lsp_client_for(state, buf) do
      nil ->
        state
      ...
      client ->
        ...
        case file_path do
          ...
          path ->
            ...
            put_in(state.workspace.lsp_pending, Map.put(state.workspace.lsp_pending, ref, :inlay_hint))
        end
    end
  end
  ...
  def schedule_inlay_hints_on_scroll(%EditorState{workspace: %{buffers: %{active: nil}}} = state), do: state
  ...
  defp build_action_range(state, _buf, line, col) do
    ...
    case state.workspace.vim.mode do
      :visual ->
        anchor =
          case state.workspace.vim.mode_state do
            %{visual_anchor: {al, ac}} -> {al, ac}
            _ -> {line, col}
          end
    ...
    case lsp_client_for(state, buf) do
      ...
      client ->
        Enum.reduce(unresolved, state, fn lens, st ->
          ...
          %{st | workspace: %{st.workspace | lsp_pending: Map.put(st.workspace.lsp_pending, ref, :code_lens_resolve)}}
        end)
    end
  end
  ...
  defp read_range_from_buffer(%EditorState{workspace: %{buffers: %{active: buf}}}, {sl, sc}, {el, ec}) when is_pid(buf) do
  ...
  defp request_incoming_calls(state, item) do
    ...
    case lsp_client_for(state, buf) do
      ...
      client ->
        ...
        put_in(state.workspace.lsp_pending, Map.put(state.workspace.lsp_pending, ref, :incoming_calls))
    end
  end
  ...
  defp request_outgoing_calls(state, item) do
    ...
    case lsp_client_for(state, buf) do
      ...
      client ->
        ...
        put_in(state.workspace.lsp_pending, Map.put(state.workspace.lsp_pending, ref, :outgoing_calls))
    end
  end
