defmodule Minga.Editor.HighlightEvents do
  ...
  defp maybe_apply_prettify_symbols(%EditorState{workspace: %{buffers: %{active: nil}}}), do: :ok
  ...
  defp buffer_version(%EditorState{workspace: %{buffers: %{active: buf}}}), do: BufferServer.version(buf)
end
