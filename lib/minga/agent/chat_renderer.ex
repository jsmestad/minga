defmodule Minga.Agent.ChatRenderer do
  ...
  defp style_to_opts(:header1, at), do: [fg: at.heading1_fg, bold: true]
  defp style_to_opts(:header2, at), do: [fg: at.heading2_fg, bold: true]
  defp style_to_opts(:header3, at), do: [fg: at.heading3_fg]
