defmodule Minga.UI.Highlight.Grammar do
  @moduledoc """
  ...
  ## Examples
      ...
      Minga.UI.Highlight.Grammar.register_language(:org, "org")
      Minga.UI.Highlight.Grammar.register_language(:astro, "astro")
  """
  ...
  ## Examples
      ...
      iex> Minga.UI.Highlight.Grammar.language_for_filetype(:elixir)
      {:ok, "elixir"}

      iex> Minga.UI.Highlight.Grammar.language_for_filetype(:typescript_react)
      {:ok, "tsx"}

      iex> Minga.UI.Highlight.Grammar.language_for_filetype(:text)
      :unsupported
  """
