defmodule Minga.UI.Theme.Catppuccin do
  @moduledoc """
  ...
  @doc "Builds a full `Minga.UI.Theme.t()` struct from a Catppuccin palette map."
  @spec build(atom(), map()) :: Minga.UI.Theme.t()
  def build(name, p) do
    %Minga.UI.Theme{
      name: name,
      syntax: syntax(p),
      editor: %Minga.UI.Theme.Editor{
        bg: p.base,
        fg: p.text,
        tilde_fg: p.surface1,
      ...
      git: %Minga.UI.Theme.Git{
        added_fg: p.green,
        modified_fg: p.blue,
        deleted_fg: p.red
      },
      modeline: %Minga.UI.Theme.Modeline{
        bar_fg: p.text,
        bar_bg: p.mantle,
        info_fg: p.text,
        info_bg: p.surface0,
      ...
      minibuffer: %Minga.UI.Theme.Minibuffer{
        fg: p.text,
        bg: p.crust,
        warning_fg: p.yellow,
        dim_fg: p.overlay0
      },
      search: %Minga.UI.Theme.Search{
        highlight_fg: p.base,
        highlight_bg: p.yellow,
        current_bg: p.red
      },
      popup: %Minga.UI.Theme.Popup{
        fg: p.text,
        bg: p.surface0,
      ...
      dashboard: %Minga.UI.Theme.Dashboard{
        bg: p.base,
        logo_fg: p.yellow,
        heading_fg: p.blue,
        item_fg: p.text,
  ...
  @spec syntax(map()) :: Minga.UI.Theme.syntax()
  defp syntax(p) do
    %{
      # ── Keywords ────────────────────────────────────────────────────────
