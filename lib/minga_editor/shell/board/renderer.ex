defmodule MingaEditor.Shell.Board.Renderer do
  ...
  """
  @spec render(State.t(), pos_integer(), pos_integer(), MingaEditor.UI.Theme.t()) ::
          [DisplayList.draw()]
  ...
  @spec render_header(State.t(), pos_integer(), MingaEditor.UI.Theme.t()) :: [DisplayList.draw()]
  ...
  @spec render_card(Card.t(), Layout.rect(), boolean(), MingaEditor.UI.Theme.t()) ::
          [DisplayList.draw()]
  ...
  @spec render_footer(pos_integer(), pos_integer(), State.t(), MingaEditor.UI.Theme.t()) ::
          [DisplayList.draw()]
  ...
  @spec render_filter_bar(pos_integer(), pos_integer(), String.t(), MingaEditor.UI.Theme.t()) ::
          [DisplayList.draw()]
  ...
  @spec render_no_matches(pos_integer(), pos_integer(), String.t(), MingaEditor.UI.Theme.t()) ::
          [DisplayList.draw()]
  ...
  @spec render_empty_prompt(pos_integer(), pos_integer(), MingaEditor.UI.Theme.t()) ::
          [DisplayList.draw()]
