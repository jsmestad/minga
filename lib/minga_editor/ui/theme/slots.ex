defmodule MingaEditor.UI.Theme.Slots do
  @moduledoc """
  ...
  """
  @spec to_color_pairs(MingaEditor.UI.Theme.t()) :: [color_pair()]
  def to_color_pairs(%MingaEditor.UI.Theme{} = theme) do
    e = theme.editor
    t = theme.tree
    tb = theme.tab_bar
    p = theme.popup
  ...
  @spec agent_chat_pairs(MingaEditor.UI.Theme.t()) :: [color_pair()]
  ...
  @spec mode_color(MingaEditor.UI.Theme.Modeline.t(), atom()) ::
          {MingaEditor.UI.Theme.color(), MingaEditor.UI.Theme.color()}
