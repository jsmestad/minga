defmodule MingaEditor.UI.Highlight.Grammar do
  ...
  ## Examples
      ...
      MingaEditor.UI.Highlight.Grammar.register_language(:org, "org")
      MingaEditor.UI.Highlight.Grammar.register_language(:astro, "astro")
  """
  ...
  ## Examples
      ...
      iex> MingaEditor.UI.Highlight.Grammar.language_for_filetype(:elixir)
      {:ok, "elixir"}

      iex> MingaEditor.UI.Highlight.Grammar.language_for_filetype(:typescript_react)
      {:ok, "tsx"}

      iex> MingaEditor.UI.Highlight.Grammar.language_for_filetype(:text)
      :unsupported
  """
