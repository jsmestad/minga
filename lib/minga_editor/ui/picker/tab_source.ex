defmodule MingaEditor.UI.Picker.TabSource do
  @moduledoc """
  ...
  @spec tab_icon(MingaEditor.State.Tab.t()) :: String.t()
  ...
  @spec tab_display_label(MingaEditor.State.Tab.t()) :: String.t()
  defp tab_display_label(%{label: ""}), do: "[No Name]"
  defp tab_display_label(%{label: label}), do: label

  @spec tab_description(MingaEditor.State.Tab.t()) :: String.t()
