defmodule MingaEditor.RenderPipeline.ComposeHelpers do
  @moduledoc """
  ...
  def resolve_cursor(
        %{workspace: %{editing: %{mode: :search, mode_state: mode_state}}},
        _cursor_info,
        minibuffer_row
      ) do
  ...
  def resolve_cursor(
        %{workspace: %{editing: %{mode: :command, mode_state: mode_state}}},
        _cursor_info,
        minibuffer_row
      ) do
  ...
  def resolve_cursor(
        %{workspace: %{editing: %{mode: :eval, mode_state: mode_state}}},
        _cursor_info,
        minibuffer_row
      ) do
  ...
  def resolve_cursor(
        %{workspace: %{editing: %{mode: :search_prompt, mode_state: mode_state}}},
        _cursor_info,
        minibuffer_row
      ) do
