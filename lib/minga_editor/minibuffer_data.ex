defmodule MingaEditor.MinibufferData do
  @moduledoc """
  ...
  Returns a `t()` struct ready for `MingaEditor.RenderModel.UI.MinibufferBuilder`
  to project into the render model encoded by
  `Minga.Frontend.Adapter.GUI.MinibufferEncoder`.
  """
  ...
  def from_state(%{workspace: %{editing: %{mode: :search, mode_state: ms}}}) do
  ...
  def from_state(%{workspace: %{editing: %{mode: :search_prompt, mode_state: ms}}}) do
    %__MODULE__{
      visible: true,
  ...
  def from_state(%{workspace: %{editing: %{mode: :eval, mode_state: ms}}}) do
    %__MODULE__{
      visible: true,
      mode: @mode_eval,
      cursor_pos: String.length(ms.input),
  ...
  def from_state(%{workspace: %{editing: %{mode: :extension_confirm, mode_state: ms}}}) do
