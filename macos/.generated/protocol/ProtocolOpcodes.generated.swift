...
let OP_GUI_WORKSPACES: UInt8 = 0x98
let OP_GUI_NOTIFICATIONS: UInt8 = 0x99
let OP_GUI_OBSERVATORY: UInt8 = 0x9A
let OP_GUI_EDIT_TIMELINE: UInt8 = 0x9B
let OP_GUI_EXTENSION_OVERLAY: UInt8 = 0x9C
let OP_GUI_EXTENSION_PANEL: UInt8 = 0x9D
let OP_GUI_SEARCH_STATE: UInt8 = 0x9E
let OP_GUI_SIDEBARS: UInt8 = 0x9F
let OP_GUI_WINDOW_OVERLAY_DELTA: UInt8 = 0xA0
let OP_GUI_WINDOW_VIEWPORT_DELTA: UInt8 = 0xA1
let OP_GUI_WINDOW_ROWS_DELTA: UInt8 = 0xA2
...
let GUI_ACTION_WORKSPACE_RENAME: UInt8 = 0x1F
let GUI_ACTION_WORKSPACE_SET_ICON: UInt8 = 0x20
let GUI_ACTION_WORKSPACE_CLOSE: UInt8 = 0x21
...
let GUI_ACTION_NOTIFICATION_DISMISS: UInt8 = 0x45
let GUI_ACTION_NOTIFICATION_ACTION: UInt8 = 0x46
let GUI_ACTION_POWER_THERMAL_STATE: UInt8 = 0x47
let GUI_ACTION_TAB_REORDER: UInt8 = 0x48
let GUI_ACTION_TAB_PIN: UInt8 = 0x49
let GUI_ACTION_TAB_UNPIN: UInt8 = 0x4A
let GUI_ACTION_TAB_MOVE_LEFT: UInt8 = 0x4B
let GUI_ACTION_TAB_MOVE_RIGHT: UInt8 = 0x4C
let GUI_ACTION_OBSERVATORY_INSPECT: UInt8 = 0x4D
let GUI_ACTION_FONT_SIZE_ADJUST: UInt8 = 0x4E
let GUI_ACTION_TIMELINE_NAVIGATE: UInt8 = 0x4F
let GUI_ACTION_EXTENSION_PANEL_ACTION: UInt8 = 0x50
let GUI_ACTION_SEARCH_QUERY: UInt8 = 0x51
let GUI_ACTION_SEARCH_NEXT: UInt8 = 0x52
let GUI_ACTION_SEARCH_PREV: UInt8 = 0x53
let GUI_ACTION_SEARCH_REPLACE: UInt8 = 0x54
let GUI_ACTION_SEARCH_REPLACE_ALL: UInt8 = 0x55
let GUI_ACTION_SEARCH_DISMISS: UInt8 = 0x56
let GUI_ACTION_SIDEBAR_ACTION: UInt8 = 0x57

// MARK: - Wire structure sizes (from schema)

let WIRE_RECT_SIZE: Int = 8
let WIRE_SPAN_SIZE: Int = 13
let WIRE_SEARCH_MATCH_SIZE: Int = 7
let WIRE_DIAGNOSTIC_RANGE_SIZE: Int = 9
let WIRE_DOCUMENT_HIGHLIGHT_SIZE: Int = 9
let WIRE_HIT_REGION_SIZE: Int = 13
let WIRE_GUTTER_ENTRY_SIZE: Int = 10
