        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            .onTapGesture {
                if hasResult, let messageID = UInt32(exactly: messageID), messageID != 0 {
                    sendAction?(.toggle(messageID: messageID))
                }
            }
