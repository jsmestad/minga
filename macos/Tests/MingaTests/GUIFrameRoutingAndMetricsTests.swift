...
struct GUIFrameRoutingTests {
    ...
    func semanticImpact() throws {
        ...
        let cases: [(String, RenderCommand, GUIFrameImpact)] = [
            ...
            ("completion selection", .guiCompletionSelection(generation: 1, selectedItemID: "item", documentation: "docs"), .editorOverlay),
            ("hover", .guiHoverPopup(visible: false, anchorRow: 0, anchorCol: 0, focused: false, scrollOffset: 0, lines: []), .editorOverlay),
            ("picker selection", .guiPickerSelection(generation: 1, selectedItemID: 2, selectedActionID: 3), .windowOverlay),
