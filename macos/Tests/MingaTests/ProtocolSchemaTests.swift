...
struct ProtocolSchemaSwiftTests {
    ...
    func guiSemanticOpcodes() throws {
        let schema = try loadSchema()
        try expectOpcodes(schema, "gui_semantic", [("gui_window_content", OP_GUI_WINDOW_CONTENT), ("gui_hover_popup", OP_GUI_HOVER_POPUP), ("gui_signature_help", OP_GUI_SIGNATURE_HELP), ("gui_float_popup", OP_GUI_FLOAT_POPUP), ("gui_split_separators", OP_GUI_SPLIT_SEPARATORS), ("gui_git_status", OP_GUI_GIT_STATUS), ("gui_workspaces", OP_GUI_WORKSPACES), ("gui_notifications", OP_GUI_NOTIFICATIONS), ("gui_board", OP_GUI_BOARD), ("gui_agent_context", OP_GUI_AGENT_CONTEXT), ("gui_change_summary", OP_GUI_CHANGE_SUMMARY), ("gui_hover_action", OP_GUI_HOVER_ACTION), ("gui_config_state", OP_GUI_CONFIG_STATE), ("gui_observatory", OP_GUI_OBSERVATORY), ("gui_edit_timeline", OP_GUI_EDIT_TIMELINE), ("gui_extension_overlay", OP_GUI_EXTENSION_OVERLAY), ("gui_extension_panel", OP_GUI_EXTENSION_PANEL), ("gui_search_state", OP_GUI_SEARCH_STATE), ("gui_sidebars", OP_GUI_SIDEBARS), ("gui_window_overlay_delta", OP_GUI_WINDOW_OVERLAY_DELTA)])
    }
