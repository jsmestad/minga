defmodule MingaAgent.Test.ProjectView.FailingBackend do
  @moduledoc false
  ...
  @impl true
  @spec edit_file(ProjectView.t(), String.t(), String.t(), String.t()) ::
          :ok | {:error, term()}
  ...
  def promote(%ProjectView{}, :project_root) do
    {:conflict, %{conflicts: [{:conflict, "lib/auth.ex", :stale_view}], results: []}}
  end
