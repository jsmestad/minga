  ...
  describe "parse/1 basics" do
    test "write, quit, edit, buffer navigation, line jumps, and unknown commands" do
      assert_parse_cases([
        ...
        {"e", {:unknown, "e"}},
        {"w notes.md", {:save_as, ["notes.md"]}},
        {"w  lib/my file.ex", {:save_as, ["lib/my file.ex"]}},
        {"w! notes.md", {:force_save_as, ["notes.md"]}},
        {"saveas notes.md", {:save_as, ["notes.md"]}},
        {"saveas! notes.md", {:force_save_as, ["notes.md"]}},
        {"saveas", {:unknown, "saveas"}},
        {"buffers", {:buffers, []}},
        {"ls", {:buffers, []}},
        {"bnext", {:buffer_next, []}},
        {"bn", {:buffer_next, []}},
