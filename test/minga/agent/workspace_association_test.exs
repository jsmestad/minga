defmodule Minga.Agent.WorkspaceAssociationTest do
  @moduledoc """
  ...
  defp build_agent_scenario do
    ...
    {tb, ws} = TabBar.add_agent_workspace(tb, "Agent", fake_session)
  ...
  describe "workspace lifecycle" do
    test "creating agent workspace assigns session" do
      ...
      {tb, ws} = TabBar.add_agent_workspace(tb, "Research", fake_session)
    ...
    test "disclosure tier progresses with agent count" do
      ...
      {tb, _ws2} = TabBar.add_agent_workspace(tb, "Agent 2")
    ...
    test "multiple agent workspaces have distinct colors" do
      ...
      {_tb, ws3} = TabBar.add_agent_workspace(tb, "Agent 3")
