defmodule Minga.UI.Theme.LoaderTest do
  use ExUnit.Case, async: true

  alias Minga.UI.Theme.Loader
  ...
  describe "load_file/1" do
    ...
    test "face overrides are applied to the registry", %{tmp_dir: dir} do
      ...
      face = Minga.UI.Face.Registry.style_for(loaded.face_registry, "keyword")
    ...
    test "theme without inherits defaults to doom_one", %{tmp_dir: dir} do
      ...
      doom = Minga.UI.Theme.get!(:doom_one)
    ...
    test "LSP defaults are included", %{tmp_dir: dir} do
      ...
      face = Minga.UI.Face.Registry.resolve(loaded.face_registry, "@lsp.type.function")
