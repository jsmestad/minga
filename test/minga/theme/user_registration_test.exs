defmodule Minga.Theme.UserRegistrationTest do
  ...
  test "register_user_themes makes themes available via get/1" do
    ...
    loaded = %Minga.Theme.Loader.LoadedTheme{
      name: :test_user_theme,
      theme: %{doom | name: :test_user_theme},
      face_registry: Minga.Face.Registry.from_theme(doom),
  ...
  test "user themes take precedence over built-in" do
    ...
    loaded = %Minga.Theme.Loader.LoadedTheme{
      name: :doom_one,
      theme: custom,
      face_registry: Minga.Face.Registry.from_theme(custom),
