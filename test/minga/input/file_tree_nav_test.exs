defmodule Minga.Input.FileTreeNavTest do
  ...
  describe "vim navigation in file tree" do
    ...
    test "q closes the file tree", %{tmp_dir: tmp_dir} do
      ...
      assert state.file_tree_buffer == nil
    end
