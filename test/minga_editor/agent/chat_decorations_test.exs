defmodule MingaEditor.Agent.ChatDecorationsTest do
  use ExUnit.Case, async: true

  alias MingaEditor.Agent.ChatDecorations
  alias Minga.Core.Decorations

  defp test_theme do
    MingaEditor.UI.Theme.agent_theme(MingaEditor.UI.Theme.get!(MingaEditor.UI.Theme.default()))
  end
