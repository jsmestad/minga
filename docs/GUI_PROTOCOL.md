...
| 0x42 | config_update | key_len(1) + key + type_tag(1) + value_payload | Update a typed config option from the native Settings UI |
| 0x43 | config_query | (empty) | Request the current native Settings state |
