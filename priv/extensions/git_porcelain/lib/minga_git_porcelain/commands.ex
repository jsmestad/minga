defmodule MingaGitPorcelain.Commands do
  @moduledoc """
  ...
  def execute(state, :git_commit_open) do
    ...
    MingaEditor.PromptUI.open(state, MingaGitPorcelain.UI.Prompt.GitCommit)
  end
  ...
  def execute(state, :git_amend_open) do
    ...
    MingaEditor.PromptUI.open(state, MingaGitPorcelain.UI.Prompt.GitAmend, default: default_msg)
  end
